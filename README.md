...
Some important OnEdit features:

 * A full 3D graphics engine ([OneCore](https://github.com/onedit/onecore)) that supports multiple lights, shadowmaps, realtime reflections, custom materials, postFX, skinning, animation, and much more.
...
For more information, visit http:/onedit.org
