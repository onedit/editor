var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(q,v,w){q!=Array.prototype&&q!=Object.prototype&&(q[v]=w.value)};$jscomp.getGlobal=function(q){return"undefined"!=typeof window&&window===q?q:"undefined"!=typeof global&&null!=global?global:q};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(q,v,w,l){if(v){w=$jscomp.global;q=q.split(".");for(l=0;l<q.length-1;l++){var z=q[l];z in w||(w[z]={});w=w[z]}q=q[q.length-1];l=w[q];v=v(l);v!=l&&null!=v&&$jscomp.defineProperty(w,q,{configurable:!0,writable:!0,value:v})}};$jscomp.polyfill("Object.is",function(q){return q?q:function(v,q){return v===q?0!==v||1/v===1/q:v!==v&&q!==q}},"es6","es3");
$jscomp.polyfill("Array.prototype.includes",function(q){return q?q:function(v,q){var l=this;l instanceof String&&(l=String(l));var w=l.length;for(q=q||0;q<w;q++)if(l[q]==v||Object.is(l[q],v))return!0;return!1}},"es7","es3");
$jscomp.checkStringArgs=function(q,v,w){if(null==q)throw new TypeError("The 'this' value for String.prototype."+w+" must not be null or undefined");if(v instanceof RegExp)throw new TypeError("First argument to String.prototype."+w+" must not be a regular expression");return q+""};$jscomp.polyfill("String.prototype.includes",function(q){return q?q:function(v,q){return-1!==$jscomp.checkStringArgs(this,v,"includes").indexOf(v,q||0)}},"es6","es3");
$jscomp.owns=function(q,v){return Object.prototype.hasOwnProperty.call(q,v)};$jscomp.polyfill("Object.assign",function(q){return q?q:function(v,q){for(var l=1;l<arguments.length;l++){var w=arguments[l];if(w)for(var y in w)$jscomp.owns(w,y)&&(v[y]=w[y])}return v}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
$jscomp.Symbol=function(){var q=0;return function(v){return $jscomp.SYMBOL_PREFIX+(v||"")+q++}}();$jscomp.initSymbolIterator=function(){$jscomp.initSymbol();var q=$jscomp.global.Symbol.iterator;q||(q=$jscomp.global.Symbol.iterator=$jscomp.global.Symbol("iterator"));"function"!=typeof Array.prototype[q]&&$jscomp.defineProperty(Array.prototype,q,{configurable:!0,writable:!0,value:function(){return $jscomp.arrayIterator(this)}});$jscomp.initSymbolIterator=function(){}};
$jscomp.arrayIterator=function(q){var v=0;return $jscomp.iteratorPrototype(function(){return v<q.length?{done:!1,value:q[v++]}:{done:!0}})};$jscomp.iteratorPrototype=function(q){$jscomp.initSymbolIterator();q={next:q};q[$jscomp.global.Symbol.iterator]=function(){return this};return q};
$jscomp.iteratorFromArray=function(q,v){$jscomp.initSymbolIterator();q instanceof String&&(q+="");var w=0,l={next:function(){if(w<q.length){var z=w++;return{value:v(z,q[z]),done:!1}}l.next=function(){return{done:!0,value:void 0}};return l.next()}};l[Symbol.iterator]=function(){return l};return l};$jscomp.polyfill("Array.prototype.keys",function(q){return q?q:function(){return $jscomp.iteratorFromArray(this,function(v){return v})}},"es6","es3");
$jscomp.polyfill("Array.prototype.fill",function(q){return q?q:function(v,q,l){var w=this.length||0;0>q&&(q=Math.max(0,w+q));if(null==l||l>w)l=w;l=Number(l);0>l&&(l=Math.max(0,w+l));for(q=Number(q||0);q<l;q++)this[q]=v;return this}},"es6","es3");$jscomp.polyfill("Array.prototype.values",function(q){return q?q:function(){return $jscomp.iteratorFromArray(this,function(v,q){return q})}},"es8","es3");
$jscomp.polyfill("Object.values",function(q){return q?q:function(v){var q=[],l;for(l in v)$jscomp.owns(v,l)&&q.push(v[l]);return q}},"es8","es3");$jscomp.polyfill("String.prototype.startsWith",function(q){return q?q:function(v,q){var l=$jscomp.checkStringArgs(this,v,"startsWith");v+="";var w=l.length,y=v.length;q=Math.max(0,Math.min(q|0,l.length));for(var m=0;m<y&&q<w;)if(l[q++]!=v[m++])return!1;return m>=y}},"es6","es3");
$jscomp.findInternal=function(q,v,w){q instanceof String&&(q=String(q));for(var l=q.length,z=0;z<l;z++){var y=q[z];if(v.call(w,y,z,q))return{i:z,v:y}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.findIndex",function(q){return q?q:function(q,w){return $jscomp.findInternal(this,q,w).i}},"es6","es3");
(function(q){function v(a){g.debug&&console.log("Graph created");this.list_of_graphcanvas=null;this.clear();a&&this.configure(a)}function w(a,b,c,d,e,f){this.id=a;this.type=b;this.origin_id=c;this.origin_slot=d;this.target_id=e;this.target_slot=f;this._data=null;this._pos=new Float32Array(2)}function l(a){this._ctor(a)}function z(a){this._ctor(a)}function y(a,b){this.offset=new Float32Array([0,0]);this.scale=1;this.max_scale=10;this.min_scale=.1;this.onredraw=null;this.enabled=!0;this.last_mouse=
...
this.setCanvas(a,c.skip_events);this.clear();c.skip_render||this.startRendering();this.autoresize=c.autoresize}function H(a,b){return Math.sqrt((b[0]-a[0])*(b[0]-a[0])+(b[1]-a[1])*(b[1]-a[1]))}function A(a,b,c,d,e,f){return c<a&&c+e>a&&d<b&&d+f>b?!0:!1}function F(a,b){var c=a[0]+a[2],d=a[1]+a[3],e=b[1]+b[3];return a[0]>b[0]+b[2]||a[1]>e||c<b[0]||d<b[1]?!1:!0}function D(a,b){function c(a){var c=parseInt(f.style.top);f.style.top=(c+a.deltaY*b.scroll_speed).toFixed()+"px";a.preventDefault();return!0}
...
a},reloadNodes:function(a){for(var b=document.getElementsByTagName("script"),c=[],d=0;d<b.length;d++)c.push(b[d]);b=document.getElementsByTagName("head")[0];a=document.location.href+a;for(d=0;d<c.length;d++){var e=c[d].src;if(e&&e.substr(0,a.length)==a)try{g.debug&&console.log("Reloading: "+e);var f=document.createElement("script");f.type="text/javascript";f.src=e;b.appendChild(f);b.removeChild(c[d])}catch(h){if(g.throw_errors)throw h;g.debug&&console.log("Error while reloading "+e)}}g.debug&&console.log("Nodes reloaded")},
...
"undefined"!=typeof process?function(){var a=process.hrtime();return.001*a[0]+1E-6*a[1]}:function(){return(new Date).getTime()};q.LGraph=g.LGraph=v;v.supported_types=["number","string","boolean"];v.prototype.getSupportedTypes=function(){return this.supported_types||v.supported_types};v.STATUS_STOPPED=1;v.STATUS_RUNNING=2;v.prototype.clear=function(){this.stop();this.status=v.STATUS_STOPPED;this.last_link_id=this.last_node_id=0;this._version=-1;if(this._nodes)for(var a=0;a<this._nodes.length;++a){var b=
...
v.prototype.setDirtyCanvas=function(a,b){this.sendActionToCanvas("setDirty",[a,b])};v.prototype.removeLink=function(a){if(a=this.links[a]){var b=this.getNodeById(a.target_id);b&&b.disconnectInput(a.target_slot)}};v.prototype.serialize=function(){for(var a=[],b=0,c=this._nodes.length;b<c;++b)a.push(this._nodes[b].serialize());c=[];for(b in this.links){var d=this.links[b];if(!d.serialize){console.warn("weird LLink bug, link info is not a LLink but a regular object");var e=new w;for(f in d)e[f]=d[f];
d=this.links[b]=e}c.push(d.serialize())}var f=[];for(b=0;b<this._groups.length;++b)f.push(this._groups[b].serialize());a={last_node_id:this.last_node_id,last_link_id:this.last_link_id,nodes:a,links:c,groups:f,config:this.config,extra:this.extra,version:g.VERSION};if(this.onSerialize)this.onSerialize(a);return a};v.prototype.configure=function(a,b){if(a){b||this.clear();b=a.nodes;if(a.links&&a.links.constructor===Array){for(var c=[],d=0;d<a.links.length;++d){var e=a.links[d];if(e){var f=new w;f.configure(e);
c[f.id]=f}else console.warn("serialized graph link data contains errors, skipping.")}a.links=c}for(d in a)"nodes"!=d&&"groups"!=d&&(this[d]=a[d]);c=!1;this._nodes=[];if(b){d=0;for(e=b.length;d<e;++d){f=b[d];var h=g.createNode(f.type,f.title);h||(g.debug&&console.log("Node not found or has errors: "+f.type),h=new l,h.last_serialization=f,c=h.has_errors=!0);h.id=f.id;this.add(h,!0)}d=0;for(e=b.length;d<e;++d)f=b[d],(h=this.getNodeById(f.id))&&h.configure(f)}this._groups.length=0;if(a.groups)for(d=0;d<
a.groups.length;++d)b=new g.LGraphGroup,b.configure(a.groups[d]),this.add(b);this.updateExecutionOrder();this.extra=a.extra||{};if(this.onConfigure)this.onConfigure(a);this._version++;this.setDirtyCanvas(!0,!0);return c}};v.prototype.load=function(a,b){var c=this;if(a.constructor===File||a.constructor===Blob){var d=new FileReader;d.addEventListener("load",function(a){a=JSON.parse(a.target.result);c.configure(a);b&&b()});d.readAsText(a)}else{var e=new XMLHttpRequest;e.open("GET",a,!0);e.send(null);
e.onload=function(a){200!==e.status?console.error("Error loading graph:",e.status,e.response):(a=JSON.parse(e.response),c.configure(a),b&&b())};e.onerror=function(a){console.error("Error loading graph:",a)}}};v.prototype.onNodeTrace=function(a,b,c){};w.prototype.configure=function(a){a.constructor===Array?(this.id=a[0],this.origin_id=a[1],this.origin_slot=a[2],this.target_id=a[3],this.target_slot=a[4],this.type=a[5]):(this.id=a.id,this.type=a.type,this.origin_id=a.origin_id,this.origin_slot=a.origin_slot,
this.target_id=a.target_id,this.target_slot=a.target_slot)};w.prototype.serialize=function(){return[this.id,this.origin_id,this.origin_slot,this.target_id,this.target_slot,this.type]};g.LLink=w;q.LGraphNode=g.LGraphNode=l;l.prototype._ctor=function(a){this.title=a||"Unnamed";this.size=[g.NODE_WIDTH,60];this.graph=null;this._pos=new Float32Array(10,10);Object.defineProperty(this,"pos",{set:function(a){!a||2>a.length||(this._pos[0]=a[0],this._pos[1]=a[1])},get:function(){return this._pos},enumerable:!0});
this.id=-1;this.type=null;this.inputs=[];this.outputs=[];this.connections=[];this.properties={};this.properties_info=[];this.flags={}};l.prototype.configure=function(a){this.graph&&this.graph._version++;for(var b in a)if("properties"==b)for(var c in a.properties){if(this.properties[c]=a.properties[c],this.onPropertyChanged)this.onPropertyChanged(c,a.properties[c])}else null!=a[b]&&("object"==typeof a[b]?this[b]&&this[b].configure?this[b].configure(a[b]):this[b]=g.cloneObject(a[b],this[b]):this[b]=
a[b]);a.title||(this.title=this.constructor.title);if(this.inputs)for(c=0;c<this.inputs.length;++c){b=this.inputs[c];var d=this.graph?this.graph.links[b.link]:null;if(this.onConnectionsChange)this.onConnectionsChange(g.INPUT,c,!0,d,b);if(this.onInputAdded)this.onInputAdded(b)}if(this.outputs)for(c=0;c<this.outputs.length;++c){var e=this.outputs[c];if(e.links){for(b=0;b<e.links.length;++b)if(d=this.graph?this.graph.links[e.links[b]]:null,this.onConnectionsChange)this.onConnectionsChange(g.OUTPUT,c,
!0,d,e);if(this.onOutputAdded)this.onOutputAdded(e)}}if(this.widgets){for(c=0;c<this.widgets.length;++c)(b=this.widgets[c])&&b.options&&b.options.property&&this.properties[b.options.property]&&(b.value=JSON.parse(JSON.stringify(this.properties[b.options.property])));if(a.widgets_values)for(c=0;c<a.widgets_values.length;++c)this.widgets[c]&&(this.widgets[c].value=a.widgets_values[c])}if(this.onConfigure)this.onConfigure(a)};l.prototype.serialize=function(){var a={id:this.id,type:this.type,pos:this.pos,
size:this.size,flags:g.cloneObject(this.flags),order:this.order,mode:this.mode};if(this.constructor===l&&this.last_serialization)return this.last_serialization;this.inputs&&(a.inputs=this.inputs);if(this.outputs){for(var b=0;b<this.outputs.length;b++)delete this.outputs[b]._data;a.outputs=this.outputs}this.title&&this.title!=this.constructor.title&&(a.title=this.title);this.properties&&(a.properties=g.cloneObject(this.properties));if(this.widgets&&this.serialize_widgets)for(a.widgets_values=[],b=
...
b)}}};l.prototype.setOutputDataType=function(a,b){if(this.outputs&&!(-1==a||a>=this.outputs.length)){var c=this.outputs[a];if(c&&(c.type=b,this.outputs[a].links))for(c=0;c<this.outputs[a].links.length;c++)this.graph.links[this.outputs[a].links[c]].type=b}};l.prototype.getInputData=function(a,b){if(this.inputs&&!(a>=this.inputs.length||null==this.inputs[a].link)){a=this.graph.links[this.inputs[a].link];if(!a)return null;if(!b)return a.data;b=this.graph.getNodeById(a.origin_id);if(!b)return a.data;
if(b.updateOutputData)b.updateOutputData(a.origin_slot);else if(b.onExecute)b.onExecute();return a.data}};l.prototype.getInputDataType=function(a){if(!this.inputs||a>=this.inputs.length||null==this.inputs[a].link)return null;a=this.graph.links[this.inputs[a].link];if(!a)return null;var b=this.graph.getNodeById(a.origin_id);return b?(a=b.outputs[a.origin_slot])?a.type:null:a.type};l.prototype.getInputDataByName=function(a,b){a=this.findInputSlot(a);return-1==a?null:this.getInputData(a,b)};l.prototype.isInputConnected=
function(a){return this.inputs?a<this.inputs.length&&null!=this.inputs[a].link:!1};l.prototype.getInputInfo=function(a){return this.inputs?a<this.inputs.length?this.inputs[a]:null:null};l.prototype.getInputLink=function(a){return this.inputs?a<this.inputs.length?this.graph.links[this.inputs[a].link]:null:null};l.prototype.getInputNode=function(a){if(!this.inputs||a>=this.inputs.length)return null;a=this.inputs[a];return a&&null!==a.link?(a=this.graph.links[a.link])?this.graph.getNodeById(a.origin_id):
null:null};l.prototype.getInputOrProperty=function(a){if(!this.inputs||!this.inputs.length)return this.properties?this.properties[a]:null;for(var b=0,c=this.inputs.length;b<c;++b){var d=this.inputs[b];if(a==d.name&&null!=d.link&&(d=this.graph.links[d.link]))return d.data}return this.properties[a]};l.prototype.getOutputData=function(a){return!this.outputs||a>=this.outputs.length?null:this.outputs[a]._data};l.prototype.getOutputInfo=function(a){return this.outputs?a<this.outputs.length?this.outputs[a]:
null:null};l.prototype.isOutputConnected=function(a){return this.outputs?a<this.outputs.length&&this.outputs[a].links&&this.outputs[a].links.length:!1};l.prototype.isAnyOutputConnected=function(){if(!this.outputs)return!1;for(var a=0;a<this.outputs.length;++a)if(this.outputs[a].links&&this.outputs[a].links.length)return!0;return!1};l.prototype.getOutputNodes=function(a){if(!this.outputs||0==this.outputs.length||a>=this.outputs.length)return null;a=this.outputs[a];if(!a.links||0==a.links.length)return null;
...
a};l.prototype.onAfterExecuteNode=function(a,b){var c=this.findOutputSlot("onExecuted");-1!=c&&this.triggerSlot(c,a,null,b)};l.prototype.changeMode=function(a){switch(a){case g.ON_EVENT:break;case g.ON_TRIGGER:this.addOnTriggerInput();this.addOnExecutedOutput();break;case g.NEVER:break;case g.ALWAYS:break;case g.ON_REQUEST:break;default:return!1}this.mode=a;return!0};l.prototype.doExecute=function(a,b){b=b||{};this.onExecute&&(b.action_call||(b.action_call=this.id+"_exec_"+Math.floor(9999*Math.random())),
this.graph.nodes_executing[this.id]=!0,this.onExecute(a,b),this.graph.nodes_executing[this.id]=!1,this.exec_version=this.graph.iteration,b&&b.action_call&&(this.action_call=b.action_call,this.graph.nodes_executedAction[this.id]=b.action_call));this.execute_triggered=2;if(this.onAfterExecuteNode)this.onAfterExecuteNode(a,b)};l.prototype.actionDo=function(a,b,c){c=c||{};this.onAction&&(c.action_call||(c.action_call=this.id+"_"+(a?a:"action")+"_"+Math.floor(9999*Math.random())),this.graph.nodes_actioning[this.id]=
a?a:"actioning",this.onAction(a,b,c),this.graph.nodes_actioning[this.id]=!1,c&&c.action_call&&(this.action_call=c.action_call,this.graph.nodes_executedAction[this.id]=c.action_call));this.action_triggered=2;if(this.onAfterExecuteNode)this.onAfterExecuteNode(b,c)};l.prototype.trigger=function(a,b,c){if(this.outputs&&this.outputs.length){this.graph&&(this.graph._last_trigger_time=g.getTime());for(var d=0;d<this.outputs.length;++d){var e=this.outputs[d];!e||e.type!==g.EVENT||a&&e.name!=a||this.triggerSlot(d,
b,null,c)}}};l.prototype.triggerSlot=function(a,b,c,d){d=d||{};if(this.outputs)if(null==a)console.error("slot must be a number");else if(a.constructor!==Number&&console.warn("slot must be a number, use node.trigger('name') if you want to use a string"),(a=this.outputs[a])&&(a=a.links)&&a.length){this.graph&&(this.graph._last_trigger_time=g.getTime());for(var e=0;e<a.length;++e){var f=a[e];if(null==c||c==f){var h=this.graph.links[a[e]];h&&(h._last_time=g.getTime(),f=this.graph.getNodeById(h.target_id))&&
(f.mode===g.ON_TRIGGER?(d.action_call||(d.action_call=this.id+"_trigg_"+Math.floor(9999*Math.random())),f.onExecute&&f.doExecute(b,d)):f.onAction&&(d.action_call||(d.action_call=this.id+"_act_"+Math.floor(9999*Math.random())),h=f.inputs[h.target_slot],f.actionDo(h.name,b,d)))}}}};l.prototype.clearTriggeredSlot=function(a,b){if(this.outputs&&(a=this.outputs[a])&&(a=a.links)&&a.length)for(var c=0;c<a.length;++c){var d=a[c];if(null==b||b==d)if(d=this.graph.links[a[c]])d._last_time=0}};l.prototype.setSize=
function(a){this.size=a;if(this.onResize)this.onResize(this.size)};l.prototype.addProperty=function(a,b,c,d){c={name:a,type:c,default_value:b};if(d)for(var e in d)c[e]=d[e];this.properties_info||(this.properties_info=[]);this.properties_info.push(c);this.properties||(this.properties={});this.properties[a]=b;return c};l.prototype.addOutput=function(a,b,c){a={name:a,type:b,links:null};if(c)for(var d in c)a[d]=c[d];this.outputs||(this.outputs=[]);this.outputs.push(a);if(this.onOutputAdded)this.onOutputAdded(a);
g.auto_load_slot_types&&g.registerNodeAndSlotType(this,b,!0);this.setSize(this.computeSize());this.setDirtyCanvas(!0,!0);return a};l.prototype.addOutputs=function(a){for(var b=0;b<a.length;++b){var c=a[b],d={name:c[0],type:c[1],link:null};if(a[2])for(var e in c[2])d[e]=c[2][e];this.outputs||(this.outputs=[]);this.outputs.push(d);if(this.onOutputAdded)this.onOutputAdded(d);g.auto_load_slot_types&&g.registerNodeAndSlotType(this,c[1],!0)}this.setSize(this.computeSize());this.setDirtyCanvas(!0,!0)};l.prototype.removeOutput=
...
this.setSize(this.computeSize());if(this.onInputAdded)this.onInputAdded(a);g.registerNodeAndSlotType(this,b);this.setDirtyCanvas(!0,!0);return a};l.prototype.addInputs=function(a){for(var b=0;b<a.length;++b){var c=a[b],d={name:c[0],type:c[1],link:null};if(a[2])for(var e in c[2])d[e]=c[2][e];this.inputs||(this.inputs=[]);this.inputs.push(d);if(this.onInputAdded)this.onInputAdded(d);g.registerNodeAndSlotType(this,c[1])}this.setSize(this.computeSize());this.setDirtyCanvas(!0,!0)};l.prototype.removeInput=
function(a){this.disconnectInput(a);for(var b=this.inputs.splice(a,1),c=a;c<this.inputs.length;++c)if(this.inputs[c]){var d=this.graph.links[this.inputs[c].link];d&&--d.target_slot}this.setSize(this.computeSize());if(this.onInputRemoved)this.onInputRemoved(a,b[0]);this.setDirtyCanvas(!0,!0)};l.prototype.addConnection=function(a,b,c,d){a={name:a,type:b,pos:c,direction:d,links:null};this.connections.push(a);return a};l.prototype.computeSize=function(a){function b(a){return a?d*a.length*.6:0}if(this.constructor.size)return this.constructor.size.concat();
var c=Math.max(this.inputs?this.inputs.length:1,this.outputs?this.outputs.length:1);a=a||new Float32Array([0,0]);c=Math.max(c,1);var d=g.NODE_TEXT_SIZE,e=b(this.title),f=0,h=0;if(this.inputs)for(var k=0,p=this.inputs.length;k<p;++k){var n=this.inputs[k];n=n.label||n.name||"";n=b(n);f<n&&(f=n)}if(this.outputs)for(k=0,p=this.outputs.length;k<p;++k)n=this.outputs[k],n=n.label||n.name||"",n=b(n),h<n&&(h=n);a[0]=Math.max(f+h+10,e);a[0]=Math.max(a[0],g.NODE_WIDTH);this.widgets&&this.widgets.length&&(a[0]=
Math.max(a[0],1.5*g.NODE_WIDTH));a[1]=(this.constructor.slot_start_y||0)+c*g.NODE_SLOT_HEIGHT;c=0;if(this.widgets&&this.widgets.length){k=0;for(p=this.widgets.length;k<p;++k)c=this.widgets[k].computeSize?c+(this.widgets[k].computeSize(a[0])[1]+4):c+(g.NODE_WIDGET_HEIGHT+4);c+=8}a[1]=this.widgets_up?Math.max(a[1],c):null!=this.widgets_start_y?Math.max(a[1],c+this.widgets_start_y):a[1]+c;this.constructor.min_height&&a[1]<this.constructor.min_height&&(a[1]=this.constructor.min_height);a[1]+=6;return a};
l.prototype.getPropertyInfo=function(a){var b=null;if(this.properties_info)for(var c=0;c<this.properties_info.length;++c)if(this.properties_info[c].name==a){b=this.properties_info[c];break}this.constructor["@"+a]&&(b=this.constructor["@"+a]);this.constructor.widgets_info&&this.constructor.widgets_info[a]&&(b=this.constructor.widgets_info[a]);!b&&this.onGetPropertyInfo&&(b=this.onGetPropertyInfo(a));b||(b={});b.type||(b.type=typeof this.properties[a]);"combo"==b.widget&&(b.type="enum");return b};l.prototype.addWidget=
function(a,b,c,d,e){this.widgets||(this.widgets=[]);!e&&d&&d.constructor===Object&&(e=d,d=null);e&&e.constructor===String&&(e={property:e});d&&d.constructor===String&&(e||(e={}),e.property=d,d=null);d&&d.constructor!==Function&&(console.warn("addWidget: callback must be a function"),d=null);b={type:a.toLowerCase(),name:b,value:c,callback:d,options:e||{}};void 0!==b.options.y&&(b.y=b.options.y);d||b.options.callback||b.options.property||console.warn("LiteGraph addWidget(...) without a callback or property assigned");
...
function(a,b,c,d){return this.findSlotByType(!0,a,b,c,d)};l.prototype.findOutputSlotByType=function(a,b,c,d){return this.findSlotByType(!1,a,b,c,d)};l.prototype.findSlotByType=function(a,b,c,d,e){c=c||!1;d=d||!1;e=e||!1;a=a?this.inputs:this.outputs;if(!a)return-1;if(""==b||"*"==b)b=0;for(var f=0,h=a.length;f<h;++f){var k=(b+"").toLowerCase().split(","),p="0"==a[f].type||"*"==a[f].type?"0":a[f].type;p=(p+"").toLowerCase().split(",");for(sI=0;sI<k.length;sI++)for(dI=0;dI<p.length;dI++)if("_event_"==
k[sI]&&(k[sI]=g.EVENT),"_event_"==p[sI]&&(p[sI]=g.EVENT),"*"==k[sI]&&(k[sI]=0),"*"==p[sI]&&(p[sI]=0),!(k[sI]!=p[dI]||d&&a[f].links&&null!==a[f].links))return c?a[f]:f}if(d&&!e)for(f=0,h=a.length;f<h;++f)for(k=(b+"").toLowerCase().split(","),p="0"==a[f].type||"*"==a[f].type?"0":a[f].type,p=(p+"").toLowerCase().split(","),sI=0;sI<k.length;sI++)for(dI=0;dI<p.length;dI++)if("*"==k[sI]&&(k[sI]=0),"*"==p[sI]&&(p[sI]=0),k[sI]==p[dI])return c?a[f]:f;return-1};l.prototype.connectByType=function(a,b,c,d){d=
...
1!=this.onMouse(a)){if(1!=a.which||this.pointer_is_double)if(2==a.which){if(g.middle_click_slot_add_default_node&&f&&this.allow_interaction&&!d&&!this.read_only&&!this.connecting_node&&!f.flags.collapsed&&!this.live_mode){e=d=h=!1;if(f.outputs)for(t=0,k=f.outputs.length;t<k;++t)if(p=f.outputs[t],n=f.getConnectionPos(!1,t),A(a.canvasX,a.canvasY,n[0]-15,n[1]-10,30,20)){h=p;d=t;e=!0;break}if(f.inputs)for(t=0,k=f.inputs.length;t<k;++t)if(p=f.inputs[t],n=f.getConnectionPos(!0,t),A(a.canvasX,a.canvasY,
n[0]-15,n[1]-10,30,20)){h=p;d=t;e=!1;break}h&&!1!==d&&(t=.5-(d+1)/(e?f.outputs.length:f.inputs.length),h=f.getBounding(),this.createDefaultNodeForSlot({nodeFrom:e?f:null,slotFrom:e?d:null,nodeTo:e?null:f,slotTo:e?null:d,position:[e?h[0]+h[2]:h[0],a.canvasY-80],nodeType:"AUTO",posAdd:[e?30:-30,130*-t],posSizeFix:[e?0:-1,0]}))}}else 3!=a.which&&!this.pointer_is_double||!this.allow_interaction||d||this.read_only||(f&&(Object.keys(this.selected_nodes).length&&(this.selected_nodes[f.id]||a.shiftKey||a.ctrlKey||
...
0;for(var k=f.outputs.length;t<k;++t){var p=f.outputs[t],n=f.getConnectionPos(!1,t);if(A(a.canvasX,a.canvasY,n[0]-15,n[1]-10,30,20)){this.connecting_node=f;this.connecting_output=p;this.connecting_output.slot_index=t;this.connecting_pos=f.getConnectionPos(!1,t);this.connecting_slot=t;g.shift_click_do_break_link_from&&a.shiftKey&&f.disconnectOutput(t);if(e){if(f.onOutputDblClick)f.onOutputDblClick(t,a)}else if(f.onOutputClick)f.onOutputClick(t,a);d=!0;break}}}if(f.inputs)for(t=0,k=f.inputs.length;t<
k;++t)if(p=f.inputs[t],n=f.getConnectionPos(!0,t),A(a.canvasX,a.canvasY,n[0]-15,n[1]-10,30,20)){if(e){if(f.onInputDblClick)f.onInputDblClick(t,a)}else if(f.onInputClick)f.onInputClick(t,a);null!==p.link&&(n=this.graph.links[p.link],g.click_do_break_link_to&&(f.disconnectInput(t),d=this.dirty_bgcanvas=!0),this.allow_reconnect_links||a.shiftKey)&&(g.click_do_break_link_to||f.disconnectInput(t),this.connecting_node=this.graph._nodes_by_id[n.origin_id],this.connecting_slot=n.origin_slot,this.connecting_output=
this.connecting_node.outputs[this.connecting_slot],this.connecting_pos=this.connecting_node.getConnectionPos(!1,this.connecting_slot),d=this.dirty_bgcanvas=!0);d||(this.connecting_node=f,this.connecting_input=p,this.connecting_input.slot_index=t,this.connecting_pos=f.getConnectionPos(!0,t),this.connecting_slot=t,d=this.dirty_bgcanvas=!0)}}if(!d){var t=!1;k=[a.canvasX-f.pos[0],a.canvasY-f.pos[1]];if(n=this.processNodeWidgets(f,this.graph_mouse,a))t=!0,this.node_widget=[f,n];if(e&&this.selected_nodes[f.id]){if(f.onDblClick)f.onDblClick(a,
...
-1!=f&&d.outputs[f]?(h=d.outputs[f].type,g.isValidConnection(this.connecting_input.type,h)&&(this._highlight_output=e)):this._highlight_output=null));this.canvas&&(A(a.canvasX,a.canvasY,d.pos[0]+d.size[0]-5,d.pos[1]+d.size[1]-5,5,5)?this.canvas.style.cursor="se-resize":this.canvas.style.cursor="crosshair")}else{e=null;for(b=0;b<this.visible_links.length;++b)if(f=this.visible_links[b],h=f._pos,!(!h||a.canvasX<h[0]-4||a.canvasX>h[0]+4||a.canvasY<h[1]-4||a.canvasY>h[1]+4)){e=f;break}e!=this.over_link_center&&
...
c>=this.viewport[0]&&c<this.viewport[0]+this.viewport[2]&&d>=this.viewport[1]&&d<this.viewport[1]+this.viewport[3])return c=this.ds.scale,0<b?c*=1.1:0>b&&(c*=1/1.1),this.ds.changeScale(c,[a.clientX,a.clientY]),this.graph.change(),a.preventDefault(),!1}};m.prototype.isOverNodeBox=function(a,b,c){var d=g.NODE_TITLE_HEIGHT;return A(b,c,a.pos[0]+2,a.pos[1]+2-d,d-4,d-4)?!0:!1};m.prototype.isOverNodeInput=function(a,b,c,d){if(a.inputs)for(var e=0,f=a.inputs.length;e<f;++e){var h=a.getConnectionPos(!0,e);
if(a.horizontal?A(b,c,h[0]-5,h[1]-10,10,20):A(b,c,h[0]-10,h[1]-5,40,10))return d&&(d[0]=h[0],d[1]=h[1]),e}return-1};m.prototype.isOverNodeOutput=function(a,b,c,d){if(a.outputs)for(var e=0,f=a.outputs.length;e<f;++e){var h=a.getConnectionPos(!1,e);if(a.horizontal?A(b,c,h[0]-5,h[1]-10,10,20):A(b,c,h[0]-10,h[1]-5,40,10))return d&&(d[0]=h[0],d[1]=h[1]),e}return-1};m.prototype.processKey=function(a){if(this.graph){var b=!1;if("input"!=a.target.localName){if("keydown"==a.type){if(32==a.keyCode&&(b=this.dragging_canvas=
...
1;c.fillStyle="#888";c.font="14px Arial";c.textAlign="left";c.fillText("Graph Inputs",20,34);if(this.drawButton(180,20,20,20,"X","#151515"))this.closeSubgraph();else{d=50;c.font="14px Arial";if(b.inputs)for(var f=0;f<b.inputs.length;++f){var h=b.inputs[f];if(!h.not_subgraph_input){if(this.drawButton(20,d+2,180,e-2)){var k=b.constructor.input_node_type||"graph/input";this.graph.beforeChange();var p=g.createNode(k);p?(a.add(p),this.block_click=!1,this.last_click_position=null,this.selectNodes([p]),
this.node_dragged=p,this.dragging_canvas=!1,p.setProperty("name",h.name),p.setProperty("type",h.type),this.node_dragged.pos[0]=this.graph_mouse[0]-5,this.node_dragged.pos[1]=this.graph_mouse[1]-5,this.graph.afterChange()):console.error("graph input node not found:",k)}c.fillStyle="#9C9";c.beginPath();c.arc(184,d+.5*e,5,0,2*Math.PI);c.fill();c.fillStyle="#AAA";c.fillText(h.name,30,d+.75*e);c.fillStyle="#777";c.fillText(h.type,130,d+.75*e);d+=e}}this.drawButton(20,d+2,180,e-2,"+","#151515","#222")&&
...
else{d=50;c.font="14px Arial";if(b.outputs)for(var h=0;h<b.outputs.length;++h){var k=b.outputs[h];if(!k.not_subgraph_input){if(this.drawButton(e-200,d+2,180,f-2)){var p=b.constructor.output_node_type||"graph/output";this.graph.beforeChange();var n=g.createNode(p);n?(a.add(n),this.block_click=!1,this.last_click_position=null,this.selectNodes([n]),this.node_dragged=n,this.dragging_canvas=!1,n.setProperty("name",k.name),n.setProperty("type",k.type),this.node_dragged.pos[0]=this.graph_mouse[0]-5,this.node_dragged.pos[1]=
this.graph_mouse[1]-5,this.graph.afterChange()):console.error("graph input node not found:",p)}c.fillStyle="#9C9";c.beginPath();c.arc(e-200+16,d+.5*f,5,0,2*Math.PI);c.fill();c.fillStyle="#AAA";c.fillText(k.name,e-200+30,d+.75*f);c.fillStyle="#777";c.fillText(k.type,e-200+130,d+.75*f);d+=f}}this.drawButton(e-200,d+2,180,f-2,"+","#151515","#222")&&this.showSubgraphPropertiesDialogRight(b)}};m.prototype.drawButton=function(a,b,c,d,e,f,h,k){var p=this.ctx;f=f||g.NODE_DEFAULT_COLOR;h=h||"#555";k=k||g.NODE_TEXT_COLOR;
var n=b+g.NODE_TITLE_HEIGHT+2,t=this.mouse,r=g.isInsideRectangle(t[0],t[1],a,n,c,d);n=(t=this.last_click_position)&&g.isInsideRectangle(t[0],t[1],a,n,c,d);p.fillStyle=r?h:f;n&&(p.fillStyle="#AAA");p.beginPath();p.roundRect(a,b,c,d,[4]);p.fill();null!=e&&e.constructor==String&&(p.fillStyle=k,p.textAlign="center",p.font=(.65*d|0)+"px Arial",p.fillText(e,a+.5*c,b+.75*d),p.textAlign="left");a=n&&!this.block_click;n&&this.blockClick();return a};m.prototype.isAreaClicked=function(a,b,c,d,e){var f=this.mouse;
...
2*this.ds.scale,b.shadowBlur=3*this.ds.scale):b.shadowColor="transparent";if(!a.flags.collapsed||!a.onDrawCollapsed||1!=a.onDrawCollapsed(b,this)){var h=a._shape||g.BOX_SHAPE;B.set(a.size);var k=a.horizontal;if(a.flags.collapsed){b.font=this.inner_text_font;var p=a.getTitle?a.getTitle():a.title;null!=p&&(a._collapsed_width=Math.min(a.size[0],b.measureText(p).width+2*g.NODE_TITLE_HEIGHT),B[0]=a._collapsed_width,B[1]=0)}a.clip_area&&(b.save(),b.beginPath(),h==g.BOX_SHAPE?b.rect(0,0,B[0],B[1]):h==g.ROUND_SHAPE?
b.roundRect(0,0,B[0],B[1],[10]):h==g.CIRCLE_SHAPE&&b.arc(.5*B[0],.5*B[1],.5*B[0],0,2*Math.PI),b.clip());a.has_errors&&(d="red");this.drawNodeShape(a,b,B,c,d,a.is_selected,a.mouseOver);b.shadowColor="transparent";if(a.onDrawForeground)a.onDrawForeground(b,this,this.canvas);b.textAlign=k?"center":"left";b.font=this.inner_text_font;d=!e;var n=this.connecting_output;h=this.connecting_input;b.lineWidth=1;p=0;var t=new Float32Array(2);if(!a.flags.collapsed){if(a.inputs)for(c=0;c<a.inputs.length;c++){var r=
a.inputs[c],m=r.type,l=r.shape;b.globalAlpha=f;this.connecting_output&&!g.isValidConnection(r.type,n.type)&&(b.globalAlpha=.4*f);b.fillStyle=null!=r.link?r.color_on||this.default_connection_color_byType[m]||this.default_connection_color.input_on:r.color_off||this.default_connection_color_byTypeOff[m]||this.default_connection_color_byType[m]||this.default_connection_color.input_off;var u=a.getConnectionPos(!0,c,t);u[0]-=a.pos[0];u[1]-=a.pos[1];p<u[1]+.5*g.NODE_SLOT_HEIGHT&&(p=u[1]+.5*g.NODE_SLOT_HEIGHT);
...
2,u[1]+2,2,2)):e?b.rect(u[0]-4,u[1]-4,8,8):b.arc(u[0],u[1],4,0,2*Math.PI);b.fill();d&&(m=null!=r.label?r.label:r.name)&&(b.fillStyle=g.NODE_TEXT_COLOR,k||r.dir==g.UP?b.fillText(m,u[0],u[1]-10):b.fillText(m,u[0]+10,u[1]+5))}b.textAlign=k?"center":"right";b.strokeStyle="black";if(a.outputs)for(c=0;c<a.outputs.length;c++)if(r=a.outputs[c],m=r.type,l=r.shape,this.connecting_input&&!g.isValidConnection(m,h.type)&&(b.globalAlpha=.4*f),u=a.getConnectionPos(!1,c,t),u[0]-=a.pos[0],u[1]-=a.pos[1],p<u[1]+.5*
g.NODE_SLOT_HEIGHT&&(p=u[1]+.5*g.NODE_SLOT_HEIGHT),b.fillStyle=r.links&&r.links.length?r.color_on||this.default_connection_color_byType[m]||this.default_connection_color.output_on:r.color_off||this.default_connection_color_byTypeOff[m]||this.default_connection_color_byType[m]||this.default_connection_color.output_off,b.beginPath(),"array"==m&&(l=g.GRID_SHAPE),n=!0,m===g.EVENT||l===g.BOX_SHAPE?k?b.rect(u[0]-5+.5,u[1]-8+.5,10,14):b.rect(u[0]-6+.5,u[1]-5+.5,14,10):l===g.ARROW_SHAPE?(b.moveTo(u[0]+8,
u[1]+.5),b.lineTo(u[0]-4,u[1]+6+.5),b.lineTo(u[0]-4,u[1]-6+.5),b.closePath()):l===g.GRID_SHAPE?(b.rect(u[0]-4,u[1]-4,2,2),b.rect(u[0]-1,u[1]-4,2,2),b.rect(u[0]+2,u[1]-4,2,2),b.rect(u[0]-4,u[1]-1,2,2),b.rect(u[0]-1,u[1]-1,2,2),b.rect(u[0]+2,u[1]-1,2,2),b.rect(u[0]-4,u[1]+2,2,2),b.rect(u[0]-1,u[1]+2,2,2),b.rect(u[0]+2,u[1]+2,2,2),n=!1):e?b.rect(u[0]-4,u[1]-4,8,8):b.arc(u[0],u[1],4,0,2*Math.PI),b.fill(),!e&&n&&b.stroke(),d&&(m=null!=r.label?r.label:r.name))b.fillStyle=g.NODE_TEXT_COLOR,k||r.dir==g.DOWN?
b.fillText(m,u[0],u[1]-8):b.fillText(m,u[0]-10,u[1]+5);b.textAlign="left";b.globalAlpha=1;if(a.widgets){r=p;if(k||a.widgets_up)r=2;null!=a.widgets_start_y&&(r=a.widgets_start_y);this.drawNodeWidgets(a,r,b,this.node_widget&&this.node_widget[0]==a?this.node_widget[1]:null)}}else if(this.render_collapsed_slots){e=f=null;if(a.inputs)for(c=0;c<a.inputs.length;c++)if(r=a.inputs[c],null!=r.link){f=r;break}if(a.outputs)for(c=0;c<a.outputs.length;c++)r=a.outputs[c],r.links&&r.links.length&&(e=r);f&&(f=0,c=
...
function(a,b,c,d,e,f,h){b.strokeStyle=d;b.fillStyle=e;e=g.NODE_TITLE_HEIGHT;var k=.5>this.ds.scale,p=a._shape||a.constructor.shape||g.ROUND_SHAPE,n=a.constructor.title_mode,t=!0;n==g.TRANSPARENT_TITLE||n==g.NO_TITLE?t=!1:n==g.AUTOHIDE_TITLE&&h&&(t=!0);x[0]=0;x[1]=t?-e:0;x[2]=c[0]+1;x[3]=t?c[1]+e:c[1];h=b.globalAlpha;b.beginPath();p==g.BOX_SHAPE||k?b.fillRect(x[0],x[1],x[2],x[3]):p==g.ROUND_SHAPE||p==g.CARD_SHAPE?b.roundRect(x[0],x[1],x[2],x[3],p==g.CARD_SHAPE?[this.round_radius,this.round_radius,
0,0]:[this.round_radius]):p==g.CIRCLE_SHAPE&&b.arc(.5*c[0],.5*c[1],.5*c[0],0,2*Math.PI);b.fill();!a.flags.collapsed&&t&&(b.shadowColor="transparent",b.fillStyle="rgba(0,0,0,0.2)",b.fillRect(0,-1,x[2],2));b.shadowColor="transparent";if(a.onDrawBackground)a.onDrawBackground(b,this,this.canvas,this.graph_mouse);if(t||n==g.TRANSPARENT_TITLE){if(a.onDrawTitleBar)a.onDrawTitleBar(b,e,c,this.ds.scale,d);else if(n!=g.TRANSPARENT_TITLE&&(a.constructor.title_color||this.render_title_colored)){t=a.constructor.title_color||
d;a.flags.collapsed&&(b.shadowColor=g.DEFAULT_SHADOW_COLOR);if(this.use_gradients){var r=m.gradients[t];r||(r=m.gradients[t]=b.createLinearGradient(0,0,400,0),r.addColorStop(0,t),r.addColorStop(1,"#000"));b.fillStyle=r}else b.fillStyle=t;b.beginPath();p==g.BOX_SHAPE||k?b.rect(0,-e,c[0]+1,e):(p==g.ROUND_SHAPE||p==g.CARD_SHAPE)&&b.roundRect(0,-e,c[0]+1,e,a.flags.collapsed?[this.round_radius]:[this.round_radius,this.round_radius,0,0]);b.fill();b.shadowColor="transparent"}t=!1;g.node_box_coloured_by_mode&&
g.NODE_MODES_COLORS[a.mode]&&(t=g.NODE_MODES_COLORS[a.mode]);g.node_box_coloured_when_on&&(t=a.action_triggered?"#FFF":a.execute_triggered?"#AAA":t);if(a.onDrawTitleBox)a.onDrawTitleBox(b,e,c,this.ds.scale);else p==g.ROUND_SHAPE||p==g.CIRCLE_SHAPE||p==g.CARD_SHAPE?(k&&(b.fillStyle="black",b.beginPath(),b.arc(.5*e,-.5*e,6,0,2*Math.PI),b.fill()),b.fillStyle=a.boxcolor||t||g.NODE_DEFAULT_BOXCOLOR,k?b.fillRect(.5*e-5,-.5*e-5,10,10):(b.beginPath(),b.arc(.5*e,-.5*e,5,0,2*Math.PI),b.fill())):(k&&(b.fillStyle=
...
-h),b.fill());if(a.onDrawTitle)a.onDrawTitle(b)}if(f){if(a.onBounding)a.onBounding(x);n==g.TRANSPARENT_TITLE&&(x[1]-=e,x[3]+=e);b.lineWidth=1;b.globalAlpha=.8;b.beginPath();p==g.BOX_SHAPE?b.rect(-6+x[0],-6+x[1],12+x[2],12+x[3]):p==g.ROUND_SHAPE||p==g.CARD_SHAPE&&a.flags.collapsed?b.roundRect(-6+x[0],-6+x[1],12+x[2],12+x[3],[2*this.round_radius]):p==g.CARD_SHAPE?b.roundRect(-6+x[0],-6+x[1],12+x[2],12+x[3],[2*this.round_radius,2,2*this.round_radius,2]):p==g.CIRCLE_SHAPE&&b.arc(.5*c[0],.5*c[1],.5*c[0]+
...
c=this.graph._nodes;for(var d=0,e=c.length;d<e;++d){var f=c[d];if(f.inputs&&f.inputs.length)for(var h=0;h<f.inputs.length;++h){var k=f.inputs[h];if(k&&null!=k.link&&(k=this.graph.links[k.link])){var p=this.graph.getNodeById(k.origin_id);if(null!=p){var n=k.origin_slot;var t=-1==n?[p.pos[0]+10,p.pos[1]+10]:p.getConnectionPos(!1,n,J);var r=f.getConnectionPos(!0,h,K);C[0]=t[0];C[1]=t[1];C[2]=r[0]-t[0];C[3]=r[1]-t[1];0>C[2]&&(C[0]+=C[2],C[2]=Math.abs(C[2]));0>C[3]&&(C[1]+=C[3],C[3]=Math.abs(C[3]));if(F(C,
G)){var m=p.outputs[n];n=f.inputs[h];if(m&&n&&(p=m.dir||(p.horizontal?g.DOWN:g.RIGHT),n=n.dir||(f.horizontal?g.UP:g.LEFT),this.renderLink(a,t,r,k,!1,0,null,p,n),k&&k._last_time&&1E3>b-k._last_time)){m=2-.002*(b-k._last_time);var l=a.globalAlpha;a.globalAlpha=l*m;this.renderLink(a,t,r,k,!0,m,"white",p,n);a.globalAlpha=l}}}}}}a.globalAlpha=1};m.prototype.renderLink=function(a,b,c,d,e,f,h,k,p,n){d&&this.visible_links.push(d);!h&&d&&(h=d.color||m.link_type_colors[d.type]);h||(h=this.default_link_color);
null!=d&&this.highlighted_links[d.id]&&(h="#FFF");k=k||g.RIGHT;p=p||g.LEFT;var t=H(b,c);this.render_connections_border&&.6<this.ds.scale&&(a.lineWidth=this.connections_width+4);a.lineJoin="round";n=n||1;1<n&&(a.lineWidth=.5);a.beginPath();for(var r=0;r<n;r+=1){var l=5*(r-.5*(n-1));if(this.links_render_mode==g.SPLINE_LINK){a.moveTo(b[0],b[1]+l);var q=0,u=0,v=0,w=0;switch(k){case g.LEFT:q=-.25*t;break;case g.RIGHT:q=.25*t;break;case g.UP:u=-.25*t;break;case g.DOWN:u=.25*t}switch(p){case g.LEFT:v=-.25*
t;break;case g.RIGHT:v=.25*t;break;case g.UP:w=-.25*t;break;case g.DOWN:w=.25*t}a.bezierCurveTo(b[0]+q,b[1]+u+l,c[0]+v,c[1]+w+l,c[0],c[1]+l)}else if(this.links_render_mode==g.LINEAR_LINK){a.moveTo(b[0],b[1]+l);w=v=u=q=0;switch(k){case g.LEFT:q=-1;break;case g.RIGHT:q=1;break;case g.UP:u=-1;break;case g.DOWN:u=1}switch(p){case g.LEFT:v=-1;break;case g.RIGHT:v=1;break;case g.UP:w=-1;break;case g.DOWN:w=1}a.lineTo(b[0]+15*q,b[1]+15*u+l);a.lineTo(c[0]+15*v,c[1]+15*w+l);a.lineTo(c[0],c[1]+l)}else if(this.links_render_mode==
g.STRAIGHT_LINK)a.moveTo(b[0],b[1]),l=b[0],q=b[1],u=c[0],v=c[1],k==g.RIGHT?l+=10:q+=10,p==g.LEFT?u-=10:v-=10,a.lineTo(l,q),a.lineTo(.5*(l+u),q),a.lineTo(.5*(l+u),v),a.lineTo(u,v),a.lineTo(c[0],c[1]);else return}this.render_connections_border&&.6<this.ds.scale&&!e&&(a.strokeStyle="rgba(0,0,0,0.5)",a.stroke());a.lineWidth=this.connections_width;a.fillStyle=a.strokeStyle=h;a.stroke();e=this.computeConnectionPoint(b,c,.5,k,p);d&&d._pos&&(d._pos[0]=e[0],d._pos[1]=e[1]);.6<=this.ds.scale&&this.highquality_render&&
p!=g.CENTER&&(this.render_connection_arrows&&(r=this.computeConnectionPoint(b,c,.25,k,p),t=this.computeConnectionPoint(b,c,.26,k,p),d=this.computeConnectionPoint(b,c,.75,k,p),n=this.computeConnectionPoint(b,c,.76,k,p),this.render_curved_connections?(t=-Math.atan2(t[0]-r[0],t[1]-r[1]),n=-Math.atan2(n[0]-d[0],n[1]-d[1])):n=t=c[1]>b[1]?0:Math.PI,a.save(),a.translate(r[0],r[1]),a.rotate(t),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore(),a.save(),a.translate(d[0],d[1]),
a.rotate(n),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore()),a.beginPath(),a.arc(e[0],e[1],5,0,2*Math.PI),a.fill());if(f)for(a.fillStyle=h,r=0;5>r;++r)f=(.001*g.getTime()+.2*r)%1,e=this.computeConnectionPoint(b,c,f,k,p),a.beginPath(),a.arc(e[0],e[1],5,0,2*Math.PI),a.fill()};m.prototype.computeConnectionPoint=function(a,b,c,d,e){d=d||g.RIGHT;e=e||g.LEFT;var f=H(a,b),h=[a[0],a[1]],k=[b[0],b[1]];switch(d){case g.LEFT:h[0]+=-.25*f;break;case g.RIGHT:h[0]+=.25*f;break;case g.UP:h[1]+=
...
this.ds.scale;c.save();c.globalAlpha=this.editor_alpha;for(var p=g.WIDGET_OUTLINE_COLOR,n=g.WIDGET_BGCOLOR,t=g.WIDGET_TEXT_COLOR,r=g.WIDGET_SECONDARY_TEXT_COLOR,m=0;m<f.length;++m){var l=f[m],u=b;l.y&&(u=l.y);l.last_y=u;c.strokeStyle=p;c.fillStyle="#222";c.textAlign="left";l.disabled&&(c.globalAlpha*=.5);var q=l.width||e;switch(l.type){case "button":l.clicked&&(c.fillStyle="#AAA",l.clicked=!1,this.dirty_canvas=!0);c.fillRect(15,u,q-30,h);k&&!l.disabled&&c.strokeRect(15,u,q-30,h);k&&(c.textAlign="center",
c.fillStyle=t,c.fillText(l.name,.5*q,u+.7*h));break;case "toggle":c.textAlign="left";c.strokeStyle=p;c.fillStyle=n;c.beginPath();k?c.roundRect(15,u,q-30,h,[.5*h]):c.rect(15,u,q-30,h);c.fill();k&&!l.disabled&&c.stroke();c.fillStyle=l.value?"#89A":"#333";c.beginPath();c.arc(q-30,u+.5*h,.36*h,0,2*Math.PI);c.fill();k&&(c.fillStyle=r,null!=l.name&&c.fillText(l.name,30,u+.7*h),c.fillStyle=l.value?t:r,c.textAlign="right",c.fillText(l.value?l.options.on||"true":l.options.off||"false",q-40,u+.7*h));break;
case "slider":c.fillStyle=n;c.fillRect(15,u,q-30,h);var v=l.options.max-l.options.min,w=(l.value-l.options.min)/v;c.fillStyle=d==l?"#89A":"#678";c.fillRect(15,u,w*(q-30),h);k&&!l.disabled&&c.strokeRect(15,u,q-30,h);l.marker&&(v=(l.marker-l.options.min)/v,c.fillStyle="#AA9",c.fillRect(15+v*(q-30),u,2,h));k&&(c.textAlign="center",c.fillStyle=t,c.fillText(l.name+"  "+Number(l.value).toFixed(3),.5*q,u+.7*h));break;case "number":case "combo":c.textAlign="left";c.strokeStyle=p;c.fillStyle=n;c.beginPath();
k?c.roundRect(15,u,q-30,h,[.5*h]):c.rect(15,u,q-30,h);c.fill();k&&(l.disabled||c.stroke(),c.fillStyle=t,l.disabled||(c.beginPath(),c.moveTo(31,u+5),c.lineTo(21,u+.5*h),c.lineTo(31,u+h-5),c.fill(),c.beginPath(),c.moveTo(q-15-16,u+5),c.lineTo(q-15-6,u+.5*h),c.lineTo(q-15-16,u+h-5),c.fill()),c.fillStyle=r,c.fillText(l.name,35,u+.7*h),c.fillStyle=t,c.textAlign="right","number"==l.type?c.fillText(Number(l.value).toFixed(void 0!==l.options.precision?l.options.precision:3),q-30-20,u+.7*h):(v=l.value,l.options.values&&
(w=l.options.values,w.constructor===Function&&(w=w()),w&&w.constructor!==Array&&(v=w[l.value])),c.fillText(v,q-30-20,u+.7*h)));break;case "string":case "text":c.textAlign="left";c.strokeStyle=p;c.fillStyle=n;c.beginPath();k?c.roundRect(15,u,q-30,h,[.5*h]):c.rect(15,u,q-30,h);c.fill();k&&(l.disabled||c.stroke(),c.save(),c.beginPath(),c.rect(15,u,q-30,h),c.clip(),c.fillStyle=r,null!=l.name&&c.fillText(l.name,30,u+.7*h),c.fillStyle=t,c.textAlign="right",c.fillText(String(l.value).substr(0,30),q-30,u+
.7*h),c.restore());break;default:l.draw&&l.draw(c,a,q,u,h)}b+=(l.computeSize?l.computeSize(q)[1]:h)+4;c.globalAlpha=this.editor_alpha}c.restore();c.textAlign="left"};m.prototype.processNodeWidgets=function(a,b,c,d){function e(d,e){d.value=e;d.options&&d.options.property&&void 0!==a.properties[d.options.property]&&a.setProperty(d.options.property,e);d.callback&&d.callback(d.value,p,a,b,c)}if(!a.widgets||!a.widgets.length)return null;for(var f=b[0]-a.pos[0],h=b[1]-a.pos[1],k=a.size[0],p=this,n=this.getCanvasWindow(),
t=0;t<a.widgets.length;++t){var r=a.widgets[t];if(r&&!r.disabled){var m=r.computeSize?r.computeSize(k)[1]:g.NODE_WIDGET_HEIGHT,l=r.width||k;if(r==d||!(6>f||f>l-12||h<r.last_y||h>r.last_y+m||void 0===r.last_y)){d=r.value;switch(r.type){case "button":c.type===g.pointerevents_method+"down"&&(r.callback&&setTimeout(function(){r.callback(r,p,a,b,c)},20),this.dirty_canvas=r.clicked=!0);break;case "slider":n=Math.clamp((f-15)/(l-30),0,1);r.value=r.options.min+(r.options.max-r.options.min)*n;r.callback&&
...
b.pos=a.convertEventToCanvasOffset(c);a.graph.add(b)};m.onMenuAdd=function(a,b,c,d,e){function f(a,b){var d=[];g.getNodeTypesCategories(h.filter||p.filter).filter(function(b){return b.startsWith(a)}).map(function(b){if(b){b=b.replace(new RegExp("^("+a+")"),"").split("/")[0];var c=""===a?b+"/":a+b+"/";-1!=b.indexOf("::")&&(b=b.split("::")[1]);-1===d.findIndex(function(a){return a.value===c})&&d.push({value:c,content:b,has_submenu:!0,callback:function(a,b,c,d){f(a.value,d)}})}});g.getNodeTypesInCategory(a.slice(0,
-1),h.filter||p.filter).map(function(a){a.skip_list||d.push({value:a.type,content:a.title,has_submenu:!1,callback:function(a,b,c,d){b=d.getFirstEvent();h.graph.beforeChange();if(a=g.createNode(a.value))a.pos=h.convertEventToCanvasOffset(b),h.graph.add(a);e&&e(a);h.graph.afterChange()}})});new g.ContextMenu(d,{event:c,parentMenu:b},k)}var h=m.active_canvas,k=h.getCanvasWindow(),p=h.graph;if(p)return f("",d),!1};m.onMenuCollapseAll=function(){};m.onMenuNodeEdit=function(){};m.showMenuNodeOptionalInputs=
function(a,b,c,d,e){if(e){var f=this;a=m.active_canvas.getCanvasWindow();b=e.optional_inputs;e.onGetInputs&&(b=e.onGetInputs());var h=[];if(b)for(var k=0;k<b.length;k++){var p=b[k];if(p){var n=p[0];p[2]||(p[2]={});p[2].label&&(n=p[2].label);p[2].removable=!0;n={content:n,value:p};p[1]==g.ACTION&&(n.className="event");h.push(n)}else h.push(null)}e.onMenuNodeInputs&&(b=e.onMenuNodeInputs(h))&&(h=b);if(h.length)return new g.ContextMenu(h,{event:c,callback:function(a,b,c){if(e&&(a.callback&&a.callback.call(f,
...
if(e.onNodeOutputAdd)e.onNodeOutputAdd(a.value);e.setDirtyCanvas(!0,!0);e.graph.afterChange()}else{a=[];for(var k in c)a.push({content:k,value:c[k]});new g.ContextMenu(a,{event:b,callback:f,parentMenu:d,node:e});return!1}}if(e){var h=this;a=m.active_canvas.getCanvasWindow();b=e.optional_outputs;e.onGetOutputs&&(b=e.onGetOutputs());var k=[];if(b)for(var p=0;p<b.length;p++){var n=b[p];if(!n)k.push(null);else if(!e.flags||!e.flags.skip_repeated_outputs||-1==e.findOutputSlot(n[0])){var t=n[0];n[2]||(n[2]=
{});n[2].label&&(t=n[2].label);n[2].removable=!0;t={content:t,value:n};n[1]==g.EVENT&&(t.className="event");k.push(t)}}this.onMenuNodeOutputs&&(k=this.onMenuNodeOutputs(k));g.do_add_triggers_slots&&-1==e.findOutputSlot("onExecuted")&&k.push({content:"On Executed",value:["onExecuted",g.EVENT,{nameLocked:!0}],className:"event"});e.onMenuNodeOutputs&&(b=e.onMenuNodeOutputs(k))&&(k=b);if(k.length)return new g.ContextMenu(k,{event:c,callback:f,parentMenu:d,node:e},a),!1}};m.onShowMenuNodeProperties=function(a,
b,c,d,e){if(e&&e.properties){var f=m.active_canvas;b=f.getCanvasWindow();var h=[],k;for(k in e.properties){a=void 0!==e.properties[k]?e.properties[k]:" ";"object"==typeof a&&(a=JSON.stringify(a));var p=e.getPropertyInfo(k);if("enum"==p.type||"combo"==p.type)a=m.getPropertyPrintableValue(a,p.values);a=m.decodeHTML(a);h.push({content:"<span class='property_name'>"+(p.label?p.label:k)+"</span><span class='property_value'>"+a+"</span>",value:k})}if(h.length)return new g.ContextMenu(h,{event:c,callback:function(a,
...
a.findInputSlot(e.name);break;case "number":f=e;e=d?a.outputs[e]:a.inputs[e];break;default:return console.warn("Cant get slot information "+e),!1}a=["Add Node",null];c.allow_searchbox&&(a.push("Search"),a.push(null));var h=e.type==g.EVENT?"_event_":e.type,k=d?g.slot_types_default_out:g.slot_types_default_in;if(k&&k[h])if("object"==typeof k[h]||"array"==typeof k[h])for(var p in k[h])a.push(k[h][p]);else a.push(k[h]);var n=new g.ContextMenu(a,{event:b.e,title:(e&&""!=e.name?e.name+(h?" | ":""):"")+
(e&&h?h:""),callback:function(a,g,k){switch(a){case "Add Node":m.onMenuAdd(null,null,k,n,function(a){d?b.nodeFrom.connectByType(f,a,h):b.nodeTo.connectByTypeOutput(f,a,h)});break;case "Search":d?c.showSearchBox(k,{node_from:b.nodeFrom,slot_from:e,type_filter_in:h}):c.showSearchBox(k,{node_to:b.nodeTo,slot_from:e,type_filter_out:h});break;default:c.createDefaultNodeForSlot(Object.assign(b,{position:[b.e.canvasX,b.e.canvasY],nodeType:a}))}}});return!1};m.onShowPropertyEditor=function(a,b,c,d,e){function f(){if(p){var b=
p.value;"Number"==a.type?b=Number(b):"Boolean"==a.type&&(b=!!b);e[h]=b;k.parentNode&&k.parentNode.removeChild(k);e.setDirtyCanvas(!0,!0)}}var h=a.property||"title";b=e[h];var k=document.createElement("div");k.is_modified=!1;k.className="graphdialog";k.innerHTML="<span class='name'></span><input autofocus type='text' class='value'/><button>OK</button>";k.close=function(){k.parentNode&&k.parentNode.removeChild(k)};k.querySelector(".name").innerText=h;var p=k.querySelector(".value");p&&(p.value=b,p.addEventListener("blur",
function(a){this.focus()}),p.addEventListener("keydown",function(a){k.is_modified=!0;if(27==a.keyCode)k.close();else if(13==a.keyCode)f();else if(13!=a.keyCode&&"textarea"!=a.target.localName)return;a.preventDefault();a.stopPropagation()}));b=m.active_canvas.canvas;c=b.getBoundingClientRect();var n=d=-20;c&&(d-=c.left,n-=c.top);event?(k.style.left=event.clientX+d+"px",k.style.top=event.clientY+n+"px"):(k.style.left=.5*b.width+d+"px",k.style.top=.5*b.height+n+"px");k.querySelector("button").addEventListener("click",
...
"<span class='name'></span> <input autofocus type='text' class='value'/><button class='rounded'>OK</button>";h.close=function(){f.prompt_box=null;h.parentNode&&h.parentNode.removeChild(h)};e=m.active_canvas.canvas;e.parentNode.appendChild(h);1<this.ds.scale&&(h.style.transform="scale("+this.ds.scale+")");var k=null,p=!1;g.pointerListenerAdd(h,"leave",function(a){p||g.dialog_close_on_mouse_leave&&!h.is_modified&&g.dialog_close_on_mouse_leave&&(k=setTimeout(h.close,g.dialog_close_on_mouse_leave_delay))});
g.pointerListenerAdd(h,"enter",function(a){g.dialog_close_on_mouse_leave&&k&&clearTimeout(k)});var n=h.querySelectorAll("select");n&&n.forEach(function(a){a.addEventListener("click",function(a){p++});a.addEventListener("blur",function(a){p=0});a.addEventListener("change",function(a){p=-1})});f.prompt_box&&f.prompt_box.close();f.prompt_box=h;h.querySelector(".name").innerText=a;var t=h.querySelector(".value");t.value=b;t.addEventListener("keydown",function(a){h.is_modified=!0;if(27==a.keyCode)h.close();
else if(13==a.keyCode&&"textarea"!=a.target.localName)c&&c(this.value),h.close();else return;a.preventDefault();a.stopPropagation()});h.querySelector("button").addEventListener("click",function(a){c&&c(t.value);f.setDirty(!0);h.close()});a=e.getBoundingClientRect();n=b=-20;a&&(b-=a.left,n-=a.top);d?(h.style.left=d.clientX+b+"px",h.style.top=d.clientY+n+"px"):(h.style.left=.5*e.width+b+"px",h.style.top=.5*e.height+n+"px");setTimeout(function(){t.focus()},10);return h};m.search_limit=-1;m.prototype.showSearchBox=
...
function(a,c){c=c||{};c=Object.assign({skipFilter:!1,inTypeOverride:!1,outTypeOverride:!1},c);var e=g.registered_node_types[a];if(n&&e.filter!=n||(!b.show_all_if_empty||d)&&-1===a.toLowerCase().indexOf(d))return!1;if(b.do_type_filter&&!c.skipFilter){e=l.value;!1!==c.inTypeOverride&&(e=c.inTypeOverride);if(l&&e&&g.registered_slot_in_types[e]&&g.registered_slot_in_types[e].nodes&&(e=g.registered_slot_in_types[e].nodes.includes(a),!1===e))return!1;e=r.value;!1!==c.outTypeOverride&&(e=c.outTypeOverride);
if(r&&e&&g.registered_slot_out_types[e]&&g.registered_slot_out_types[e].nodes&&(e=g.registered_slot_out_types[e].nodes.includes(a),!1===e))return!1}return!0};var p=0;d=d.toLowerCase();var n=h.filter||h.graph.filter;if(b.do_type_filter&&f.search_box)var l=f.search_box.querySelector(".slot_in_type_filter"),r=f.search_box.querySelector(".slot_out_type_filter");else r=l=!1;for(k in g.searchbox_extras){var t=g.searchbox_extras[k];if(b.show_all_if_empty&&!d||-1!==t.desc.toLowerCase().indexOf(d)){var q=
g.registered_node_types[t.type];if((!q||q.filter==n)&&e(t.type)&&(a(t.desc,"searchbox_extra"),-1!==m.search_limit&&p++>m.search_limit))break}}t=null;if(Array.prototype.filter)t=Object.keys(g.registered_node_types).filter(e);else for(k in t=[],g.registered_node_types)e(k)&&t.push(k);for(k=0;k<t.length&&!(a(t[k]),-1!==m.search_limit&&p++>m.search_limit);k++);if(b.show_general_after_typefiltered&&(l.value||r.value)){filtered_extra=[];for(k in g.registered_node_types)e(k,{inTypeOverride:l&&l.value?"*":
!1,outTypeOverride:r&&r.value?"*":!1})&&filtered_extra.push(k);for(k=0;k<filtered_extra.length&&!(a(filtered_extra[k],"generic_type"),-1!==m.search_limit&&p++>m.search_limit);k++);}if((l.value||r.value)&&0==u.childNodes.length&&b.show_general_if_none_on_typefilter){filtered_extra=[];for(k in g.registered_node_types)e(k,{skipFilter:!0})&&filtered_extra.push(k);for(k=0;k<filtered_extra.length&&!(a(filtered_extra[k],"not_in_filter"),-1!==m.search_limit&&p++>m.search_limit);k++);}}}def_options={slot_from:null,
node_from:null,node_to:null,do_type_filter:g.search_filter_enabled,type_filter_in:!1,type_filter_out:!1,show_general_if_none_on_typefilter:!0,show_general_after_typefiltered:!0,hide_on_mouse_leave:g.search_hide_on_mouse_leave,show_all_if_empty:!0,show_all_on_open:g.search_show_all_on_open};b=Object.assign(def_options,b||{});var f=this,h=m.active_canvas,k=h.canvas,p=k.ownerDocument||document,n=document.createElement("div");n.className="litegraph litesearchbox graphdialog rounded";n.innerHTML="<span class='name'>Search</span> <input autofocus type='text' class='value rounded'/>";
b.do_type_filter&&(n.innerHTML+="<select class='slot_in_type_filter'><option value=''></option></select>",n.innerHTML+="<select class='slot_out_type_filter'><option value=''></option></select>");n.innerHTML+="<div class='helper'></div>";p.fullscreenElement?p.fullscreenElement.appendChild(n):(p.body.appendChild(n),p.body.style.overflow="hidden");if(b.do_type_filter)var t=n.querySelector(".slot_in_type_filter"),r=n.querySelector(".slot_out_type_filter");n.close=function(){f.search_box=null;this.blur();
k.focus();p.body.style.overflow="";setTimeout(function(){f.canvas.focus()},20);n.parentNode&&n.parentNode.removeChild(n)};1<this.ds.scale&&(n.style.transform="scale("+this.ds.scale+")");if(b.hide_on_mouse_leave){var l=!1,q=null;g.pointerListenerAdd(n,"enter",function(a){q&&(clearTimeout(q),q=null)});g.pointerListenerAdd(n,"leave",function(a){l||(q=setTimeout(function(){n.close()},500))});b.do_type_filter&&(t.addEventListener("click",function(a){l++}),t.addEventListener("blur",function(a){l=0}),t.addEventListener("change",
function(a){l=-1}),r.addEventListener("click",function(a){l++}),r.addEventListener("blur",function(a){l=0}),r.addEventListener("change",function(a){l=-1}))}f.search_box&&f.search_box.close();f.search_box=n;var u=n.querySelector(".helper"),v=null,w=null,x=null,z=n.querySelector("input");z&&(z.addEventListener("blur",function(a){this.focus()}),z.addEventListener("keydown",function(a){if(38==a.keyCode)d(!1);else if(40==a.keyCode)d(!0);else if(27==a.keyCode)n.close();else if(13==a.keyCode)x?c(x.innerHTML):
v?c(v):n.close();else{w&&clearInterval(w);w=setTimeout(e,250);return}a.preventDefault();a.stopPropagation();a.stopImmediatePropagation();return!0}));if(b.do_type_filter){if(t){var y=g.slot_types_in,C=y.length;if(b.type_filter_in==g.EVENT||b.type_filter_in==g.ACTION)b.type_filter_in="_event_";for(var A=0;A<C;A++){var B=document.createElement("option");B.value=y[A];B.innerHTML=y[A];t.appendChild(B);!1!==b.type_filter_in&&(b.type_filter_in+"").toLowerCase()==(y[A]+"").toLowerCase()&&(B.selected=!0)}t.addEventListener("change",
function(){e()})}if(r){y=g.slot_types_out;C=y.length;if(b.type_filter_out==g.EVENT||b.type_filter_out==g.ACTION)b.type_filter_out="_event_";for(A=0;A<C;A++)B=document.createElement("option"),B.value=y[A],B.innerHTML=y[A],r.appendChild(B),!1!==b.type_filter_out&&(b.type_filter_out+"").toLowerCase()==(y[A]+"").toLowerCase()&&(B.selected=!0);r.addEventListener("change",function(){e()})}}t=k.getBoundingClientRect();r=(a?a.clientY:t.top+.5*t.height)-20;n.style.left=(a?a.clientX:t.left+.5*t.width)-80+"px";
n.style.top=r+"px";a.layerY>t.height-200&&(u.style.maxHeight=t.height-a.layerY-20+"px");z.focus();b.show_all_on_open&&e();return n};m.prototype.showEditPropertyValue=function(a,b,c){function d(){e(m.value)}function e(d){f&&f.values&&f.values.constructor===Object&&void 0!=f.values[d]&&(d=f.values[d]);"number"==typeof a.properties[b]&&(d=Number(d));if("array"==h||"object"==h)d=JSON.parse(d);a.properties[b]=d;a.graph&&a.graph._version++;if(a.onPropertyChanged)a.onPropertyChanged(b,d);if(c.onclose)c.onclose();
l.close();a.setDirtyCanvas(!0,!0)}if(a&&void 0!==a.properties[b]){c=c||{};var f=a.getPropertyInfo(b),h=f.type,g="";if("string"==h||"number"==h||"array"==h||"object"==h)g="<input autofocus type='text' class='value'/>";else if("enum"!=h&&"combo"!=h||!f.values)if("boolean"==h||"toggle"==h)g="<input autofocus type='checkbox' class='value' "+(a.properties[b]?"checked":"")+"/>";else{console.warn("unknown type: "+h);return}else{g="<select autofocus type='text' class='value'>";for(var p in f.values){var n=
p;f.values.constructor===Array&&(n=f.values[p]);g+="<option value='"+n+"' "+(n==a.properties[b]?"selected":"")+">"+f.values[p]+"</option>"}g+="</select>"}var l=this.createDialog("<span class='name'>"+(f.label?f.label:b)+"</span>"+g+"<button>OK</button>",c),m=!1;if("enum"!=h&&"combo"!=h||!f.values)if("boolean"==h||"toggle"==h)(m=l.querySelector("input"))&&m.addEventListener("click",function(a){l.modified();e(!!m.checked)});else{if(m=l.querySelector("input"))m.addEventListener("blur",function(a){this.focus()}),
n=void 0!==a.properties[b]?a.properties[b]:"","string"!==h&&(n=JSON.stringify(n)),m.value=n,m.addEventListener("keydown",function(a){if(27==a.keyCode)l.close();else if(13==a.keyCode)d();else if(13!=a.keyCode){l.modified();return}a.preventDefault();a.stopPropagation()})}else m=l.querySelector("select"),m.addEventListener("change",function(a){l.modified();e(a.target.value)});m&&m.focus();l.querySelector("button").addEventListener("click",d);return l}};m.prototype.createDialog=function(a,b){def_options=
...
d.content.appendChild(e);return e};d.addButton=function(a,b,c){var e=document.createElement("button");e.innerText=a;e.options=c;e.classList.add("btn");e.addEventListener("click",b);d.footer.appendChild(e);return e};d.addSeparator=function(){var a=document.createElement("div");a.className="separator";d.content.appendChild(a)};d.addWidget=function(a,b,h,k,p){function e(a,b){k.callback&&k.callback(a,b,k);p&&p(a,b,k)}k=k||{};var f=String(h);a=a.toLowerCase();"number"==a&&(f=h.toFixed(3));var l=document.createElement("div");
l.className="property";l.innerHTML="<span class='property_name'></span><span class='property_value'></span>";l.querySelector(".property_name").innerText=k.label||b;var q=l.querySelector(".property_value");q.innerText=f;l.dataset.property=b;l.dataset.type=k.type||a;l.options=k;l.value=h;if("code"==a)l.addEventListener("click",function(a){d.inner_showCodePad(this.dataset.property)});else if("boolean"==a)l.classList.add("boolean"),h&&l.classList.add("bool-on"),l.addEventListener("click",function(){var a=
this.dataset.property;this.value=!this.value;this.classList.toggle("bool-on");this.querySelector(".property_value").innerText=this.value?"true":"false";e(a,this.value)});else if("string"==a||"number"==a)q.setAttribute("contenteditable",!0),q.addEventListener("keydown",function(b){"Enter"!=b.code||"string"==a&&b.shiftKey||(b.preventDefault(),this.blur())}),q.addEventListener("blur",function(){var a=this.innerText,b=this.parentNode.dataset.property;"number"==this.parentNode.dataset.type&&(a=Number(a));
e(b,a)});else if("enum"==a||"combo"==a)f=m.getPropertyPrintableValue(h,k.values),q.innerText=f,q.addEventListener("click",function(a){var b=this.parentNode.dataset.property,d=this;new g.ContextMenu(k.values||[],{event:a,className:"dark",callback:function(a,c,f){d.innerText=a;e(b,a);return!1}},c)});d.content.appendChild(l);return l};if(d.onOpen&&"function"==typeof d.onOpen)d.onOpen();return d};m.getPropertyPrintableValue=function(a,b){if(!b||b.constructor===Array)return String(a);if(b.constructor===
