var AboutModule = {
	...
	init: function()
	{
		LiteGUI.menubar.add("About", { callback: function() { 
			...
			dialog.content.innerHTML = "<p>onEdit version "+CORE.config.version+"</p><p>Created by <a href='http://blog.tamats.com' target='_blank'>Javi Agenjo</a></p><p><a href='http://gti.upf.edu/' target='_blank'>GTI department</a> of <a href='http://www.upf.edu' target='_blank'>Universitat Pompeu Fabra</a></p><p><a target='_blank' href='https://github.com/onedit'>Fork me in Github</a></a>";
			dialog.show();
		}});
	}
}
