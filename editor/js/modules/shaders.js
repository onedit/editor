var ShadersModule = {
	...
	updateSidebar: function()
	{
		...
		*/
		...
		{
			e.dataTransfer.setData("nodetype", LS.GraphMaterial.node_types.uniform );
	...
	showCode: function()
	{
		if(!this.graph)
			return;
		var code = this.graph._last_code;
		if(!code)
			return LiteGUI.alert("No code found");

		EditorModule.checkCode( code, "Shader Code" );
	},
